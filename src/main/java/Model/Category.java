...
public class Category implements Serializable{
    ...
    public static void logToFile(){
        try{
            FileOutputStream file = new FileOutputStream("F:\\universe\\AP\\Project_team-31\\src\\project files/allCategories.txt");
    ...
    public static void fileToLog(){
        try{
            FileInputStream file = new FileInputStream("F:\\universe\\AP\\Project_team-31\\src\\project files/allCategories.txt");
